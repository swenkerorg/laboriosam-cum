...
<p align="center"><a href="https://github.com/swenkerorg/laboriosam-cum/tree/master/docs"><strong>Docs: Getting Started →</strong></a></p>
<p align="center"><a href="https://libauth.org/#md:api-overview">API Reference</a></p>

<p align="center">
  <a href="https://www.npmjs.com/package/@swenkerorg/laboriosam-cum"><img src="https://img.shields.io/npm/v/@swenkerorg/laboriosam-cum.svg" alt="NPM version" /></a>
  <a href="https://codecov.io/gh/swenkerorg/laboriosam-cum"><img src="https://img.shields.io/codecov/c/github/swenkerorg/laboriosam-cum/master.svg" alt="Codecov" /></a>
  <a href="https://github.com/swenkerorg/laboriosam-cum/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/swenkerorg/laboriosam-cum/ci.yml?branch=master" alt="CI" /></a>
  ...
  <a href="https://www.npmjs.com/package/@swenkerorg/laboriosam-cum"><img alt="npm downloads" src="https://img.shields.io/npm/dm/@swenkerorg/laboriosam-cum"></a>
  <a href="https://github.com/swenkerorg/laboriosam-cum"><img src="https://img.shields.io/github/stars/swenkerorg/laboriosam-cum.svg?style=social&logo=github&label=Stars" alt="GitHub stars" /></a>
</p>
...
To get started, install `@swenkerorg/laboriosam-cum`:

```sh
npm install @swenkerorg/laboriosam-cum
# OR
yarn add @swenkerorg/laboriosam-cum
```

And import the functionality you need:

```ts
import { secp256k1 } from '@swenkerorg/laboriosam-cum';
...
- [Installation](https://github.com/swenkerorg/laboriosam-cum/blob/master/docs/install.md)
- [Handling Errors](https://github.com/swenkerorg/laboriosam-cum/blob/master/docs/errors.md)
- [Cryptography](https://github.com/swenkerorg/laboriosam-cum/blob/master/docs/crypto.md)
- [Keys](https://github.com/swenkerorg/laboriosam-cum/blob/master/docs/keys.md)
- [Addresses](https://github.com/swenkerorg/laboriosam-cum/blob/master/docs/addresses.md)
- [Verifying Transactions](https://github.com/swenkerorg/laboriosam-cum/blob/master/docs/verify-transactions.md)
- [Wallets & Transaction Creation](https://github.com/swenkerorg/laboriosam-cum/blob/master/docs/wallets.md)
...
Libauth's test suite includes a set of cross-implementation Virtual Machine Bytecode (VMB) test vectors for each supported VM. See [`Libauth VMB Tests`](https://github.com/swenkerorg/laboriosam-cum/blob/master/src/lib/vmb-tests/readme.md) for details.
...
Pull Requests welcome! Please see [`CONTRIBUTING.md`](https://github.com/swenkerorg/laboriosam-cum/blob/master/.github/CONTRIBUTING.md) for details.
